...
(144,'Volvo Model Replicas, Co','Berglund','Christina ','0921-12 3555','BerguvsvÃƒÂ¤gen  8',NULL,'LuleÃƒÂ¥',NULL,'S-958 22','Sweden',1504,53100.00),

(145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','VinbÃƒÂ¦ltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,83400.00),
...
(169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da saÃƒÂºde n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,0.00),

(171,'Daedalus Designs Imports','RancÃƒÂ©','Martine ','20.16.1555','184, chaussÃƒÂ©e de Tournai',NULL,'Lille',NULL,'59000','France',1370,82900.00),
...
(209,'Mini Caravy','Citeaux','FrÃƒÂ©dÃƒÂ©rique ','88.60.1555','24, place KlÃƒÂ©ber',NULL,'Strasbourg',NULL,'67000','France',1370,53800.00),
...
(216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de CataluÃƒÂ±a, 23',NULL,'Barcelona',NULL,'08022','Spain',1702,60300.00),

(219,'Boards & Toys Co.','Young','Mary','3105552373','4097 Douglas Av.',NULL,'Glendale','CA','92561','USA',1166,11000.00),

(223,'NatÃƒÂ¼rlich Autos','Kloss','Horst ','0372-555188','TaucherstraÃƒÅ¸e 10',NULL,'Cunewalde',NULL,'01307','Germany',NULL,0.00),

(227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'Ãƒâ€¦rhus',NULL,'8200','Denmark',1401,120800.00),

(233,'QuÃƒÂ©bec Home Shopping Network','FresniÃƒÂ¨re','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'MontrÃƒÂ©al','QuÃƒÂ©bec','H1J 1C3','Canada',1286,48700.00),

(237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran VÃƒÂ­a, 1',NULL,'Madrid',NULL,'28001','Spain',NULL,0.00),
...
(256,'Auto AssociÃƒÂ©s & Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l''Europe',NULL,'Versailles',NULL,'78000','France',1370,77900.00),

(259,'Toms SpezialitÃƒÂ¤ten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'KÃƒÂ¶ln',NULL,'50739','Germany',1504,120400.00),
...
(273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'MÃƒÂ¼nchen',NULL,'80805','Germany',NULL,0.00),
...
(298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'GenÃƒÂ¨ve',NULL,'1203','Switzerland',1702,141300.00),
...
(335,'Cramer SpezialitÃƒÂ¤ten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL,0.00),
...
(361,'Kommission Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'MÃƒÂ¼nster',NULL,'44087','Germany',NULL,0.00),
...
(409,'Stuttgart Collectable Exchange','MÃƒÂ¼ller','Rita ','0711-555361','Adenauerallee 900',NULL,'Stuttgart',NULL,'70563','Germany',NULL,0.00),
...
(448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','Ãƒâ€¦kergatan 24',NULL,'BrÃƒÂ¤cke',NULL,'S-844 67','Sweden',1504,116400.00),
...
(458,'Corrida Auto Replicas, Ltd','Sommer','MartÃƒÂ­n ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,104600.00),
...
(477,'Mit VergnÃƒÂ¼gen & Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL,0.00),
...
(484,'Iberia Gift Imports, Corp.','Roel','JosÃƒÂ© Pedro ','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','Spain',1702,65700.00),
...
--5. 
select jobTitles FROM employees;
--6. 
select productName FROM products ORDER by productscale;
--7.
...
--9.--
select contactFirstName, contactLastName FROM customers WHERE creditLimit = 0 ORDER BY contactLastName;
--10.--
...
--14.--
select * FROM customers WHERE customerName LIKE 'Mini%' OR customerName LIKE '% Mini %';
--15.--
...
--NATURAL JOIN--
--18.--
select * FROM orders NATURAL JOIN orderDetails WHERE orderNumber = 10270 OR orderNumber = 10272 OR orderNumber = 10279;
--19.--
select distinct productLine, productVendor FROM products NATURAL JOIN productLines;

--INNER JOIN--
--20.--
select * FROM customers INNER JOIN offices USING (state);
--21.--
SELECT distinct customerName, state FROM customers INNER JOIN offices NATURAL JOIN employees USING (state);

--MULTI JOIN--
--22.--
SELECT DISTINCT customerName, orderDate, quantityOrdered, productLine, productName FROM customers 
NATURAL JOIN orders NATURAL JOIN orderDetails NATURAL JOIN productlines NATURAL JOIN products WHERE year(orderDate) = 2015 AND year(shippedDate) = 2015; --year returns an integer

--CROSS JOIN--
--23.--
SELECT * FROM products p LEFT OUTER JOIN orderDetails o ON p.productCode = o.productCode WHERE orderNumber IS NULL; 
--24.--
SELECT customerName, salesRepEmployeeNumber FROM customers c LEFT OUTER JOIN employees e ON c.salesRepEmployeeNumber = e.employeeNumber; 

--AGGREGATE FUNCTION--
--25.--
SELECT customerNumber, customerName, SUM(amount) AS totalOrderAmount FROM payments 
NATURAL JOIN customers GROUP BY customerNumber, customerName;
--26.--
SELECT MAX(amount) FROM payments;
--27.--
SELECT AVG(amount) FROM payments;
--28.--
SELECT productLine, COUNT(productName) AS numberOfProducts FROM products GROUP BY productLine;
--29.--
SELECT status, COUNT(orderNumber) AS numberOfOrders FROM orders GROUP BY status;
--30.--
SELECT officeCode, COUNT(employeeNumber) AS numberOfEmployee FROM employees GROUP BY officeCode;

--HAVING--
--31.--
SELECT productLine, COUNT(productName) AS numberOfProducts FROM products GROUP BY productLine HAVING COUNT(productName) > 3;
--32.--
SELECT productLine, COUNT(productVendor) AS numberOfVendors FROM products GROUP BY productLine HAVING COUNT(productVendor) < 10;

--COMPUTED COLUMNS--
--33.--
SELECT orderNumber, SUM(quantityOrdered * priceEach) AS totalOfEachOrder FROM orderdetails GROUP BY orderNumber HAVING SUM(quantityOrdered * priceEach) > 55000.00 ORDER BY totalOfEachOrder DESC;
--34.--
SELECT productCode, productName, SUM(MSRP - buyPrice) AS totalOfEachOrder FROM products GROUP BY productCode, productName;
...
-- NOT IN (SELECT customernumber from orders where year(orderdate) = 2015);

--36. List all people that we deal with (employees and customer contacts). 
...
--37.--
--List the states and the country that the state is part of that have customers 
-- but not offices, offices but not customers, or both one or more customers and 
-- one or more offices all in one query.  Designate which state is which with 
-- the string 'Customer', 'Office', or 'Both'.  If a state falls 
-- into the “Both” category, do not list it as a Customer or an Office state.  
-- Order by the country, then the state.  Give the category column 
-- (where you list ‘Customer’, ‘Office’, or ‘Both’) a header of “Category” and 
-- exclude any entries in which the state is null. (19)

SELECT state, country, "Category" FROM 
(SELECT state, country, 'Offices' AS "Category" FROM offices 
EXCEPT 
SELECT state, country, 'Offices' AS "Category" FROM customers 
UNION
SELECT state, country, 'Customers' AS "Category" FROM customers WHERE state IS NOT null
EXCEPT 
SELECT state, country, 'Customers' AS "Category" FROM offices
UNION
SELECT state, country, 'Both' AS "Category" FROM customers INNER JOIN offices USING
(state, country) ORDER BY country, state) states
WHERE state IS NOT null;

--38.--
--List the Product Code and Product name of every product that has never been in
-- on order in which the customer asked for more than 48 of them.  
-- Order by the Product Name.  (8)

SELECT productCode, productName FROM products 
EXCEPT
SELECT productCode, productName FROM products 
INNER JOIN orderdetails USING (productCode) WHERE quantityOrdered > 48 ORDER BY productName;

--39.--
--List the last name, first name, and employee number of all of the employees 
-- who do not have any customers.  Order by last name first, 
-- then the first name. (8).
...
WHERE contactFirstName IS NOT NULL AND contactLastName IS NOT NULL ORDER BY lastName, firstName;

--SUBQUERIES--
--40.
--Find the first name and last name of all customer contacts whose customer is
--located in the same state as the San Francisco office. (11)

SELECT contactFirstName, contactLastName, state FROM Customers
WHERE state = (SELECT state FROM offices WHERE city = 'San Francisco');

--41.
--Which products have an MSRP within 5% of the average MSRP across all products?
--List the Product Name, the MSRP, and the average MSRP ordered by the product MSRP.

SELECT DISTINCT productName, MSRP, AVG(MSRP) AS averageMSRP FROM products 
WHERE MSRP <= 0.05 * (SELECT AVG(MSRP) FROM products) 
GROUP BY productName, MSRP ORDER BY MSRP;

--42.
--Which customer made the largest individual payment. (1)

SELECT DISTINCT customerName FROM customers NATURAL JOIN payments 
WHERE amount = (SELECT MAX(amount) FROM payments);

--43.
--Which customers made an individual payment where half of the payment is 
--more than  average payment. List their name. (8)

SELECT DISTINCT customerName FROM customers NATURAL JOIN payments 
WHERE 0.5 * amount > (SELECT AVG(amount) FROM payments);

--44.
--Which orderline is the smallest in terms of money. 
--List the order number, orderline number and the money 
--involved on that orderline. (1)

SELECT DISTINCT orderNumber, orderLineNumber, priceEach FROM orderdetails 
WHERE priceEach = (SELECT MIN(priceEach) FROM orderDetails);

--RECURSION--
--45.
--List all employees that have the same last name. 
--Make sure each combination is listed only once (5)

SELECT a.firstName, a.lastName, b.firstName, b.lastName 
FROM employees a INNER JOIN employees b USING(lastName)
WHERE a.employeeNumber < b.employeeNumber;

--46.--
--List all the first and last name of all employees and their managers. 
--Order by employee last name, then first name. (22)

SELECT e.firstName, e.lastName, m.firstName, m.lastName 
FROM employees e INNER JOIN employees m USING(lastName)
WHERE e.employeeNumber != m.employeeNumber;

--EXTRA
--47.--
SELECT productName FROM products WHERE buyPrice = (quantityInStock * buyPrice);
--48.--

--49.--
SELECT customerName, lastName "Sales Rep Last Name", firstName, "Sales Rep First Name"
FROM orders INNER JOIN customers using (customerNumber) INNER JOIN employees 
ON (salesRepEmployeeNumber = employeeNumber)
WHERE orderNumber = (SELECT orderNumber FROM orders ord WHERE 
(SELECT SUM(quantityOrdered * priceEach) FROM orderDetails WHERE
ord.orderNumber = orderNumber) = (SELECT MAX(total) FROM (SELECT orderNumber,
SUM(quantityOrdered * priceEach) AS total FROM orders INNER JOIN orderdetails 
USING (orderNumber) GROUP BY orderNumber) totals)
--50.--
...
SELECT customerName FROM customers 
INNER JOIN orders USING(customerNumber)
WHERE MONTH(orderDate) BETWEEN 07 AND 11;

--2.
SELECT contactLastName, contactFirstName, customerName FROM customers
WHERE contactLastName IN (SELECT lastName FROM employees NATURAL JOIN customers
GROUP BY lastName HAVING COUNT(lastName) >= 1);

--3.
SELECT productName, COUNT(quantityInStock * MSRP) AS inventory FROM products
GROUP BY productName HAVING COUNT(quantityInStock * MSRP) = MIN(quantityInStock * MSRP);

--4.
SELECT DISTINCT a.customerName, b.customerName
FROM customers a INNER JOIN customers b USING(postalCode)
WHERE a.customerName < b.customerName ORDER BY a.customerName, b.customerName;

--5.
SELECT city, state, "Category" FROM 
(SELECT city, state, 'Offices' AS "Category" FROM offices 
UNION
SELECT city, state, 'Offices' AS "Category" FROM customers 
UNION
SELECT city, state, 'Customers' AS "Category" FROM customers WHERE state IS NOT null
UNION
SELECT city, state, 'Customers' AS "Category" FROM offices
UNION
SELECT city, state, 'Both' AS "Category" FROM customers INNER JOIN offices USING
(city, state) ORDER BY city, state) states
WHERE state IS NOT null;
